<template>
  <section class="w-full bg-gray-900 text-white text-center">
    <div class="container mx-auto w-full p-4">

      <div class="py-4 my-8">
        <div class="w-full text-center py-4 mb-8">
          <h1>About Me</h1>
          <p>🤗 Hi there, my name is <b>Chris</b> - in the web known as <b>equaliser</b> 😎</p>
        </div>
        <div class="flex flex-wrap justify-around">

          <div class="flex flex-col items-center w-full md:w-1/4 m-2 p-4">
            <img src="~/assets/imgs/creative.png" alt="">
            <h2>Creative</h2>
            <p>There is an Artists in me. I love making Designs, Music and I love getting out of the box for solutions</p>
          </div>

          <div class="flex flex-col items-center w-full md:w-1/4 m-2 p-4">
            <img src="~/assets/imgs/developer.png" alt="">
            <h2>Developer</h2>
            <p>I am a Fullstack Developer in Typescript for Web, Native and Server Applications</p>
          </div>
